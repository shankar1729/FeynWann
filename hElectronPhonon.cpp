...
struct CollectHePh
  {
    ...
    void collectEPh(const FeynWann::ePhProcessFunc
...
{	
	InitParams ip = FeynWann::initialize(argc, argv, "Ab initio parameters for Transient Absorption analysis");
	...
	for(int iBunch=0; iBunch<nBunchesMine; iBunch++)
	{
		...
		//Move collect double integral to collectHePh
